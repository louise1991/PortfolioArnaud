...
export default function Hero() {
  ...
  return (
    <section className="container mx-auto max-w-screen-2xl py-0">
      {/* BANNIÈRE */}
      <div className="relative w-full overflow-hidden bg-gradient-to-tr from-[#9054D2] via-[#B2357B] via-[#EE5B5E] to-[#FEBD82] md:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[480px]">
        ...
        <div className="relative z-10 lg:col-span-6 flex justify-center lg:justify-center w-full">
          <Carousel
            ...
            className="w-full max-w-[650px] aspect-[16/9]"
              ...
              {carouselItems.map((item) => (
                <CarouselItem key={item.id}>
                  ...
                  <div className="w-full h-full aspect-[16/9] bg-white/25 backdrop-blur-md border border-white/20 p-8 flex flex-col justify-between text-white shadow-xl">
                    <div className="w-12 h-12 bg-white/20 flex items-center justify-center font-mono text-sm">
                      0{item.id}
                    </div>
